...
public class TestAppv1AnyFileAssessment extends TestAppv1Assessment {

	@BeforeClass
	public void setup() {
		super.setup();
		setname("test any file questions for App v1");
		setAssessmentLocation(3);
		doFileQuestions = true;
	}

	@Test(description = "test any file questions for App v1", groups = "practera_appv1_assessment_quiz_filequestions")
	public void main() {
		super.main();
	}
