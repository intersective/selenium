...
public class TestAppv1VideoAssessment extends TestAppv1Assessment {

	@BeforeClass
	public void setup() {
		super.setup();
		setname("test video questions for App v1");
		setAssessmentLocation(5);
		doFileQuestions = true;
	}

	@Test(description = "test video questions for App v1", groups = "practera_appv1_assessment_quiz_videoquestions")
	public void main() {
		super.main();
	}
